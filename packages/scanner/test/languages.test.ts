...
describe('report languages of projects', () => {
  ...
  it('report only JavaScript when there are only JavaScript files', () => {
    const report = generateReport({ files: ['data.json', 'package.json', 'src/index.js', 'bin.mjs'] })
  ...
  it('report JavaScript if there is a ".mjs" file', () => {
    const report = generateReport({ files: ['data.json', 'package.json', 'cli.mjs', 'src/index.mjs'] })
  ...
  it('report JavaScript if there is a ".cjs" file', () => {
    const report = generateReport({ files: ['data.json', 'package.json', 'cli.cjs', 'src/index.cjs'] })
  ...
  it('report JavaScript if there is a ".jsx" file', () => {
    const report = generateReport({ files: ['data.json', 'package.json', 'src/cli.jsx', 'src/index.jsx'] })
  ...
  it('report TypeScript if there is a ".tsx" file', () => {
    const report = generateReport({ files: ['data.json', 'package.json', 'src/cli.tsx', 'src/index.tsx'] })
  ...
  it('report Typescript if there is a ".d.mts" file', () => {
    const report = generateReport({ files: ['data.json', 'package.json', 'cli.d.mts', 'index.d.mts'] })
